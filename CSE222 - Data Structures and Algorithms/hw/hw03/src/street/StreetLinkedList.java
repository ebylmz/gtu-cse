...
public class StreetLinkedList implements StreetInterface, Cloneable {
    private LinkedList<Land> _landList;
    private int _streetLength;
    private LinkedList<Integer> _posSide;
    private LinkedList<Integer> _negSide;
    ...
    public StreetLinkedList(int streetLength) {
        _landList = new LinkedList<>();
        _negSide = new LinkedList<>();
        _posSide = new LinkedList<>();
        _maxLandHeight = 0;
     ...
     * @param streetLength length of the street
     */
    public StreetLinkedList(Collection<? extends Land> c, int streetLength) {
        this(streetLength);
        for (var land : c)
            add(land);
    }
     ...
     */
    private int getEmptyLandLength(LinkedList<Integer> streetSide) {
        int len = 0;
     ...
     */
    private LinkedList<Integer> getStreetSide(int location) {
     ...
     */
    private void drawSkylineSilhouette(LinkedList<Integer> streetSide, AnsiEscape.Color color) {
    ...
    public StreetLinkedList clone() {
        try {
            StreetLinkedList r = (StreetLinkedList) super.clone();
            @SuppressWarnings("unchecked")
            var tmp1 = (LinkedList<Land>) _landList.clone();
            r._landList = tmp1;

            @SuppressWarnings("unchecked")
            var tmp2 = (LinkedList<Integer>) _negSide.clone();
            r._negSide = tmp2;

            @SuppressWarnings("unchecked")
            var tmp3 = (LinkedList<Integer>) _posSide.clone();
            r._posSide = tmp3;
